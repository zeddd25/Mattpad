  ...
  return (
    <div className="hidden lg:flex flex-col items-center gap-5 font-outfit">
      ...
      <main className="w-full">
        <div
          className="flex flex-wrap gap-64 mt-[135px] justify-center md:"
          data-aos="zoom-out"
        >
          <div className="flex flex-col gap-[12px] font-outfit">
            <h1 className="font-black text-[64px]">Hai, ini Mattpad.</h1>
            <h2 className="text-[24px]">
              Platform sosial untuk bercerita yang paling <br /> disukai di
              dunia
            </h2>
            <NavLink to={"login"}>
        ...
        <div className="flex justify-center items-center bg-[url('/img/footer-texture')]">
          <div className="h-[676px] mt-10">
            <div className="flex flex-col justify-center gap-[30px] items-center mb-[55px]">
              <p className="font-semibold text-[30px]">Cara Kerjanya Mattpad</p>
            ...
            >
              ...
              <div className="flex gap-2 items-center">
                ...
                <div className="w-[274px]">
                  ...
                  <p className="font-light text-[16px] text-[#6F6F6F] mt-5">
                    Dapatkan penggemar dari seluruh dunia saat cerita kamu
                    menjadi semakin populer. Terhubung dengan penulis lain yang
                    juga suka bercerita.
                  </p>
                </div>
              </div>
              <div className="flex gap-2 items-center">
                ...
                <div className="w-[274px]">
                  ...
                  <p className="font-light text-[16px] text-[#6F6F6F] mt-5">
                    ...
                    ceritamu menjadi film atau acara televisi dengan Mattpad
                    Books dan Mattpad Studios!
                  </p>
                </div>
              </div>
            </div>
